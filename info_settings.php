...
$track_all_sites=$_POST['track_all_sites'];
$plugin_stats=trim($_POST['plugin_stats']);

if($track_all_sites=='YES'){
$track_all_site = 'track_all';
}else{
$track_all_site = '';
}
if($plugin_stats=='YES'){
...
<div class="wrap">
      ...
      <div class="set_outer">
			...
			<div class="pluginheader"><img src="../wp-content/plugins/<?php echo PROF_FOLDER; ?>/images/innometrics_logo.png"/></div>
				<div class="lowerheader"><?php $setting_word = mylang_translate('Settings');
                                echo $setting_word;?></div>
					<div class="setting_tabs">
					<a href="" id="setting_button" class="active_class"><?php echo $setting_word; ?></a>
					<a href="" id="system_status_button" class=""><?php $system_status = mylang_translate("system_status");
                                        echo $system_status;?></a>
					</div>
