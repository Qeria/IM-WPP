...
return array('Setting_code_line'=>"Please paste the code provided to your account. you can find more",
    ...
    'instal_it'=>"Install it side-wide or select the pages you want the code to be enabled.",
    'final_step'=>"Final Step!",
    'main_paste'=>"Paste your Innometrics Profile Cloud Tracking code provided to your account. you can find more",
    ...
    'With_this'=>"With this option Innometrics Profile Cloud Tracking code will be installed throughout your website",
